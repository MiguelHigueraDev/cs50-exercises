...
bool print_winner(void)
{
    // Loop over all candidates and check if one of them has a majority
    for (int i = 0; i < candidate_count; i++)
    {
        // If votes are more than 50% print winner
...
bool is_tie(int min)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // If votes != min, it means that not all candidates have the same amount of votes
